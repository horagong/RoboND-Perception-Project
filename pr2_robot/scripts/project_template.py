...
# Exercise-2 TODOs:
    ...
    outlier_filter.set_mean_k(15) #20
    ...
    ec.set_ClusterTolerance(0.03) #0.015
    ec.set_MinClusterSize(20) #
    ec.set_MaxClusterSize(2000) #3000
...
def pr2_mover(detected_objects_dict):
    ...
    print('dropbox_param=', dropbox_param)
    test_scene_num.data = rospy.get_param('/test_scene_num')
    print('dropbox_param=', test_scene_num.data)
    ...
    for d in dropbox_param:
        dropbox_dict[d['group']] = {'name': d['name'], 'position': d['position']}
    ...
    for obj in object_list_param:
        ...
        print('looking for', object_name.data, 'of', group)

        # DONE: Get the PointCloud for a given object and obtain it's centroid
        centroids = detected_objects_dict.get(object_name.data)
        if centroids is None:
            print(object_name.data, 'in object_list is not found')
            continue
        ...
        for centroid in centroids:
            ...
            dropbox_position = dropbox_dict[group]['position']
            ...
            which_arm.data = dropbox_dict[group]['name']
            ...
            print('found', yaml_dict, len(centroids))
    ...
    print('output file', yaml_filename)
...
if __name__ == '__main__':
    ...
    scaler = model['scaler']
    print('model classes=', encoder.classes_)
